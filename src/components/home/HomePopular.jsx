    ...
    <div id="HomePopular">
      <div className="container">
        ...
        <div className="PopularFilters">
          <button className={`filterBtn ${selectedCategory === "All" ? "active" : ""}`} onClick={() => setSelectedCategory("All")}>
              All
          </button>
          {categories?.map((category, index) => (
            <button key={index} className={`filterBtn ${selectedCategory === category.id ? "active" : ""}`} onClick={() => setSelectedCategory(category.id)}>
              {category.name}
            </button>
          ))}
        </div>
