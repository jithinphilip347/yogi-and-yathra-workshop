...
// export const PRODUCT_API_BASE_URL = "http://localhost:8001/api/";
// export const PRODUCT_MEDIA_BASE_URL = "http://localhost:8001/storage/";

// export const API_BASE_URL = "https://admin.varixialabs.com/workshopapi/public/api/";
